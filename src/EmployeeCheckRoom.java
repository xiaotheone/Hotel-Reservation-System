...
public class EmployeeCheckRoom extends JFrame implements ActionListener{
	...
	e1.printStackTrace();
     ...
     public static void setEmployeeCheckRoom()
    {
    	EmployeeCheckRoom frame = new EmployeeCheckRoom();
