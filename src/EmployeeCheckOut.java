...
public class EmployeeCheckOut extends JFrame implements ActionListener{
    ...
    public EmployeeCheckOut(){
        ...
        c.add(t8);
        t8.setBounds(150,350,100,20);
        t8.setEditable(false);
        
        c.add(b1);
    	b1.setBounds(310,400,100,30);
     ...
     JOptionPane.showMessageDialog(null, "Enter the Check-In room number then click the ssearch button");
       ...
       ResultSet rs = stmt.executeQuery();
         ...
         if(rs.next()){
           ...
           t7.setText(rs.getString("status"));
	...
	e1.printStackTrace();
     ...
     public static void setEmployeeCheckOut()
    {
    	EmployeeCheckOut frame = new EmployeeCheckOut();
