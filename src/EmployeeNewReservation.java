...
public class EmployeeNewReservation extends JFrame implements ActionListener{
   ...
   String SQL = "INSERT into customer(roomNumber,start_date,end_date,first_name,middle_name,last_name,phoneNumber,"
	...
	e1.printStackTrace();
      ...
      String SQL1 = "SELECT roomNumber,pricePerDay FROM room WHERE roomSize =? AND roomType = ? AND "
            ...
            + "WHERE status ='Reserved' OR status = 'Check-In' AND NOT (end_date  "
              + " < '2012-12-14'OR start_date > '2012-12-15')) LIMIT 1";
       try{
	...
	TCNum.setText("");
     ...
     public static void setEmployeeNewReservation()
    {
    	EmployeeNewReservation frame = new EmployeeNewReservation();
